...
const Tabs = (props : any) => {
    ...
    const scrollViewHome = useRef<ScrollView | null>(null);
    const onCLick = (i: number) => scrollViewHome.current?.scrollTo({ x: i * (SIZES.width - 60) });
    const scrollX2 = useRef<any>(new Animated.Value(0)).current;
    const scrollViewHome2 = useRef<ScrollView | null>(null);
    const onCLick2 = (i: number) => scrollViewHome2.current?.scrollTo({ x: i * (SIZES.width - 60) });
        ...
        <>
            ...
            >
                <View style={{
                    ...
                    <Header title={'Tabs'} bgWhite leftIcon={'back'}/>
                    <ScrollView>
                        <View style={GlobalStyleSheet.container}>
                            <View style={[styles.card,{
                                ...
                                <View style={{borderBottomWidth:1,borderColor:colors.borderColor,paddingBottom:8,marginBottom:10}}>
                                    <Text style={{...FONTS.h5,color:colors.title}}>Default Tab</Text>
                                </View>
                            ...
                            <View style={[styles.card,{
                                ...
                                <View style={{borderBottomWidth:1,borderColor:colors.borderColor,paddingBottom:8,marginBottom:10}}>
                                    <Text style={{...FONTS.h5,color:colors.title}}>Primary Tab</Text>
                                </View>
